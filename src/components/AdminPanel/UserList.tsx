...
export const UserList = () => {
  ...
  const exeptMembers = [client.userID, 'deleted-user-1234237-693e2db320a58b30cadd552e894c0ea8', 'freelancer-self-employed'] 
...
//   );
  ...
  useEffect(() => {
    ...
    if (client) getUsers();
  }, [client, createChannelType]); // eslint-disable-line react-hooks/exhaustive-deps
