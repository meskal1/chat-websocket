...
export type ChannelOrUserType = Channel<StreamChatType> | UserResponse<StreamChatType>

export const isChannel = (channel: ChannelOrUserType): channel is Channel<StreamChatType> =>
